...
$dummyReq .=   "{$AUTH}";
$dummyReq .=   "<Periodo>201512</Periodo>";
$dummyReq .=   "<Orden>1</Orden>";
$dummyReq .=  "</{$SERVICIO}>";
$dummyReq .= "</soap:Body>";
$dummyReq .= "</soap:Envelope>";

$URL_SERVICE = "https://servicios1.afip.gov.ar/wsfev1/service.asmx";
...
echo print_r($parser->FECAEAConsultarResponse->FECAEAConsultarResult, true);
